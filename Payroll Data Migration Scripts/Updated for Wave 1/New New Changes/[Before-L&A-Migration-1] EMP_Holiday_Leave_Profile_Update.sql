...
from payroll_leave_attend_data.employee_records_wave0 e inner join public.mdg_empl_profile ep on e.pin = ep.employee_code
...
FROM public.mdg_empl_profile e inner join payroll_leave_attend_data.employee_records_wave0 ep on ep.pin = e.employee_code
